...
def load_weather() -> pd.DataFrame:
    ...
    # Rename pipeline weather columns to match what the Streamlit app expects
    df = df.rename(columns={
        "daily_avg_temp_c": "forecast_avg_temp_c",
        "daily_min_temp_c": "forecast_min_temp_c",
        "daily_max_temp_c": "forecast_max_temp_c",
        "daily_avg_humidity_pct": "forecast_avg_humidity_pct",
        "daily_avg_cloudiness_pct": "forecast_avg_cloudiness_pct",
        "daily_avg_wind_speed_mps": "forecast_avg_wind_speed_mps",
        "daily_max_wind_speed_mps": "forecast_max_wind_speed_mps",
        "most_common_description": "forecast_description",
    })
